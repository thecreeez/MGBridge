...
async function start() {
  ...
  // Create room here
  new Room(application.RoomController, { bDebug: true, maxTPS: 20, code: "default", gmodUnitsPerBlock: 64, forcedGenerateMap: true, allowedGeneratingMap: true, bPrivate: false });
}
